...
export const recorridoGenerateMySQL = async () => {
   let a = 0, b = 0, c = 0, d = 0;
   ...
   if(countPacients < 25) {
      ...
      console.log(chalk.redBright.bold.italic(`${a} Pacients created - MySQL...`));
   }
   ...
   if(countNurses < 25) {
      ...
      console.log(chalk.greenBright.bold.italic(`${b} Nurses created - MySQL...`));
   }
   ...
   if(countVaccines < 50) {
      ...
      console.log(chalk.blueBright.bold.italic(`${c} Vaccines created - MySQL...`));
   }
   ...
   if(countVaccinations < 100) {
      ...
      console.log(chalk.magentaBright.bold.italic(`${d} Vaccinations created - MySQL...`));
   }
};